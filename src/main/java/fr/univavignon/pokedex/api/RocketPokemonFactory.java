...
/**
 * Team Rocket implementation of PokemonFactory interface.
 */
public class RocketPokemonFactory implements IPokemonFactory {

    // Le code ci-dessous est commenté en raison d'une erreur se produisant uniquement lors de
    // la génération de la javadoc sur CircleCI, et relatif au type de Map choisie par la Team
    // Rocket ainsi que sa librairie "org.apache.commons.collections4.map.UnmodifiableMap".
    // Le code fonctionne normalement sur un poste local et peut être décommenté.
    //
